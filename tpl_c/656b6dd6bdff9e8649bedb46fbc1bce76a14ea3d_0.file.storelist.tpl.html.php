<?php
/* Smarty version 3.1.39, created on 2021-10-30 17:05:54
  from '/Users/logichom/project/fakemarjorie/tpl/storelist.tpl.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_617d5f52b72323_41194692',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '656b6dd6bdff9e8649bedb46fbc1bce76a14ea3d' => 
    array (
      0 => '/Users/logichom/project/fakemarjorie/tpl/storelist.tpl.html',
      1 => 1635606009,
      2 => 'file',
    ),
  ),
...
function content_617d5f52b72323_41194692 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
...
<head>
    ...
    <link href="/resources/fullpage/jquery.fullPage.css" rel="stylesheet" />
			...
			<div class="container">
				...
				<div class="row container-grid">
					...
					<!-- <div class="nf-item col-md-6 col-sm-6 mb-30"> -->
						<!-- <div class="item-box"> -->
							<!-- Shop item images -->
							<!-- <a class="shop-item" href="/store/storesingle.php?gid=5291&colorid=39">
								<div class="item-img ">
									<img src="https://img.marjorie.co/goods/picmin/5291.39.01.jpg" />
                                </div>
							</a> -->
							...
							<!-- <div class="shop-item-info">
								<a href="/store/storesingle.php?gid=5291&colorid=39">
									<h6 class="shop-item-name">輕快的旋律，簡約修身牛仔喇叭褲</h6>
								</a>
								<div class="shop-item-price"><span>$2180</span></div>
							</div> -->
							<!-- Shop item info -->
						<!-- </div> -->
					<!-- </div> -->
...
?>
					<div class="nf-item col-md-6 col-sm-6 mb-30">
						<div class="item-box">
							<!-- Shop item images -->
							<a class="shop-item" href="<?php echo $_smarty_tpl->tpl_vars['item']->value['url'];?>
">
								<div class="item-img ">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				...
				<div class="pagination-nav mtb-30">
					<ul>
						<li><a href="javascript:return false;"><i class="fa fa-angle-left"></i></a></li>
						<li class="active">
							<a href="?ed=all&page=1">1</a>
						</li>
						<li class="">
							<a href="?ed=all&page=2">2</a>
						</li>
						<li class="">
							<a href="?ed=all&page=3">3</a>
						</li>
						<li class="">
							<a href="?ed=all&page=4">4</a>
						</li>
						<li><a href="?ed=all&page=2"><i class="fa fa-angle-right"></i></a></li>
					</ul>
				</div>
				<!-- End Pagination Nav -->
			</div>
